...
func (x *ProtectedReq) FastRead(buf []byte, _type int8, number int32) (offset int, err error) {
	switch number {
	case 1:
		offset, err = x.fastReadField1(buf, _type)
		if err != nil {
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, error: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' error: %s", x, number, fieldIDToName_ProtectedReq[number], err)
}

func (x *ProtectedReq) fastReadField1(buf []byte, _type int8) (offset int, err error) {
	x.Query, offset, err = fastpb.ReadString(buf, _type)
	return offset, err
}

func (x *ProtectedResp) FastRead(buf []byte, _type int8, number int32) (offset int, err error) {
	switch number {
	case 1:
		offset, err = x.fastReadField1(buf, _type)
		if err != nil {
...
SkipFieldError:
	return offset, fmt.Errorf("%T cannot parse invalid wire-format data, error: %s", x, err)
ReadFieldError:
	return offset, fmt.Errorf("%T read field %d '%s' error: %s", x, number, fieldIDToName_ProtectedResp[number], err)
}

func (x *ProtectedResp) fastReadField1(buf []byte, _type int8) (offset int, err error) {
...
func (x *ProtectedReq) FastWrite(buf []byte) (offset int) {
	if x == nil {
		return offset
	}
	offset += x.fastWriteField1(buf[offset:])
...
func (x *ProtectedReq) fastWriteField1(buf []byte) (offset int) {
	if x.Query == "" {
		return offset
	}
...
func (x *ProtectedResp) FastWrite(buf []byte) (offset int) {
	if x == nil {
		return offset
	}
	offset += x.fastWriteField1(buf[offset:])
...
func (x *ProtectedResp) fastWriteField1(buf []byte) (offset int) {
	if x.Result == "" {
		return offset
	}
...
func (x *ProtectedReq) Size() (n int) {
	if x == nil {
		return n
	}
	n += x.sizeField1()
...
func (x *ProtectedReq) sizeField1() (n int) {
	if x.Query == "" {
		return n
	}
...
func (x *ProtectedResp) Size() (n int) {
	if x == nil {
		return n
	}
	n += x.sizeField1()
...
func (x *ProtectedResp) sizeField1() (n int) {
	if x.Result == "" {
		return n
	}
...
var fieldIDToName_ProtectedReq = map[int32]string{
	1: "Query",
}

var fieldIDToName_ProtectedResp = map[int32]string{
	1: "Result",
}
