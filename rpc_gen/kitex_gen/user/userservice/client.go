...
type Client interface {
	...
	Protected(ctx context.Context, Req *user.ProtectedReq, callOptions ...callopt.Option) (r *user.ProtectedResp, err error)
}
...
func (p *kUserServiceClient) Protected(ctx context.Context, Req *user.ProtectedReq, callOptions ...callopt.Option) (r *user.ProtectedResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.Protected(ctx, Req)
}
